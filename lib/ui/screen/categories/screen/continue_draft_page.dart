...
// import 'package:plannr_app/ui/screen/categories/screen/events_page.dart';
...
// import '../../events/controller/edit_invitation_controller.dart';
//
...
//   int? yesNoIndex4;
//
//   EditInvitationController eventsCreateController =
//       Get.find<EditInvitationController>();
//
//   void getData() async {
...
//         dateController.text =
//             eventsCreateController.editInvitationDataList!.date;
//         timeController.text =
//             eventsCreateController.editInvitationDataList!.time;
//         timeController2.text =
//             eventsCreateController.editInvitationDataList!.zone;
//         hostedController.text =
//             eventsCreateController.editInvitationDataList!.hostedBy;
//         locationController.text =
//             eventsCreateController.editInvitationDataList!.location;
//         messgeController.text =
//             eventsCreateController.editInvitationDataList!.message;
//         phoneController.text =
//             eventsCreateController.editInvitationDataList!.phone;
//         soilSelect = eventsCreateController.editInvitationDataList!.typeEvents;
//         dressController.text =
//             eventsCreateController.editInvitationDataList!.dressCode;
//         foodController.text =
//             eventsCreateController.editInvitationDataList!.food;
//         addController.text =
//             eventsCreateController.editInvitationDataList!.addInfo;
//         yesNoIndex2 =
//             eventsCreateController.editInvitationDataList!.addAdmin == "No"
//                 ? 1
//                 : 0;
//         yesNoIndex3 =
//             eventsCreateController.editInvitationDataList!.addChatRoom == "No"
//                 ? 1
//                 : 0;
//         yesNoIndex4 =
//             eventsCreateController.editInvitationDataList!.inviteMore == "No"
//                 ? 1
//                 : 0;
//         setState(() {});
//       },
...
//           body: SafeArea(
//             child: GetBuilder(
//               builder: (EditInvitationController controller) {
...
//                                           controller.editInvitationDataList!.id,
...
//                                           success: (data) {
//                                             showToast(
//                                                 "Save Draft", Colors.black);
//                                             Get.toNamed(
//                                                 SaveDraftNavigeshanScreen
//                                                     .routeName);
//                                           },
//                                           failure: (ErrorType type,
//                                               String? message) {
