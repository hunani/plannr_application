...
import 'confirm_payment_sendInvite.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Image.asset(AppAssets.logoBox, height: 65),
                        SizedBox(width: 20),
                        Text(
                          "Chat Room - \$2.99",
                          style: TextStyle(
              ...
              GestureDetector(
                onTap: () {
                  if (productId == null) {
                    Get.toNamed(ConfirmPaymentSendInvitePage.routeName);
                  } else {
                    Get.toNamed(ContactsSelectScreen.routeName);
                  }
                },
                child: Container(
