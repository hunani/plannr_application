...
import 'package:plannr_app/ui/screen/profile/privacy_policy_screen.dart';
import 'package:plannr_app/ui/screen/profile/trems_of_service_screen.dart';

import '../../../widget/app_prefs.dart';
import '../../../widget/global.dart';
import '../login/properties_screen.dart';
            ...
            return SafeArea(
              child: SingleChildScrollView(
                ...
                child: Padding(
                  ...
                  child: controller.profileDataModel != null
                      ? Column(
                          children: [
                            Padding(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Get.toNamed(ContactsScreen.routeName);
                                      },
                                      child: Container(
                                        height: 40,
                                        color: Colors.transparent,
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    Get.toNamed(TermsOfServiceScreen.routeName);
                                  },
                                  child: Text(
                                    "Terms Of Service  |  ",
                                    style: TextStyle(
